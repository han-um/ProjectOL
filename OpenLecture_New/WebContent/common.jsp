...
<head>
  ...
  <title>Project OL</title>
  <!-- Font Awesome Icons -->
  <link rel="stylesheet" href="<%=request.getContextPath()%>/plugins/font-awesome/css/font-awesome.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="<%=request.getContextPath()%>/dist/css/adminlte.css">
  <!-- Google Font: Source Sans Pro -->`
  <link href="https://fonts.googleapis.com/css?family=Nunito|Nanum+Gothic" rel="stylesheet">
  <!-- Google Font: Source Sans Pro  -->
